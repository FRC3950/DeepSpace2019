...
public class LineRecognizerCommandV2 extends Command {

  Joystick stick = null;

  public LineRecognizerCommandV2() {
  ...
  @Override
  protected void end() {
   lastLineFollowerState = Robot.lineFollowerSubsystem.getLineFollowerState();
  }
