      ...
      if (data != null && !data.isEmpty()) {
        ...
        if (dataArr != null && dataArr.length > 0) {
          ...
          if (leftRightData != null && leftRightData.length == 2) {
            ...
            // System.out.println("dL=" + distanceLeft + " dR=" + distanceRight + " W=" +
            // detectorWidth);
            // if (robotAnglesCounter == 100) {
            //   System.out.println("max=" + Arrays.stream(robotAngles).max() + "  min=" + Arrays.stream(robotAngles).min()
            //       + "  avg=" + Arrays.stream(robotAngles).average());
